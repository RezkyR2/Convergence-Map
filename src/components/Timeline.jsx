...
const Timeline = ({ frameworks, setPinnedFramework }) => {
  ...
  return (
    <section className="mb-8 sm:mb-10 md:mb-12 p-3 sm:p-4 md:p-6 bg-gray-800/50 rounded-lg">
      ...
      <div className="relative w-full overflow-x-auto pb-3 sm:pb-4 -mx-1 px-1 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
        <div className="flex gap-1 sm:gap-1.5 md:gap-2 min-w-max">
          {years.map(year => (
            <div key={year} className="flex-1 min-w-[70px] sm:min-w-[85px] md:min-w-[100px]">
              ...
              <div className="relative h-40 sm:h-44 md:h-48 bg-gray-700/50 rounded p-1 space-y-0.5 sm:space-y-1">
